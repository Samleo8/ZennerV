...
//Copied from : https://github.com/signalapp/Signal-Android/blob/master/src/org/thoughtcrime/securesms/scribbles/widget/CanvasView.java
/*
    TODO:
        Adding of images.
        Fine-tuning so that it is specialised to add N arrow, saluter text, and rectangle for blurring
        Change the clear function somehow
 */
